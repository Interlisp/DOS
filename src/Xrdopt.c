/* @(#) Xrdopt.c Version 1.5 (7/24/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) Xrdopt.c	1.5 7/24/92	(venue & Fuji Xerox)";
/*
*
*
*
...
extern int LispDisplayRequestedX,
  ...
  char **argv;
{
    ...
    if (XrmGetResource(rDB,
      ...
      (void)strcpy(Window_Title,
		   "Medley (C) Copyright 1980-93 by Venue and Fuji Xerox");
    }
    if (XrmGetResource(rDB,
		       "ldex.icontitle",
		       "Ldex.icontitle",
...
print_Xusage( prog )
  char *prog;
  {
    ...
    fprintf(stderr, "call our tech support at (800)228-5325 or (415)508-9672.\n\n");
    exit(0);
  } /* end print_Xusage() */
