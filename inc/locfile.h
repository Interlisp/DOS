/* @(#) locfile.h Version 1.1 (4/21/92). copyright Venue & Fuji Xerox  */
/* @(#) locfile.h Version 2.29 (6/20/90). copyright envos & Fuji Xerox  */
 ...
 */
#ifdef DOS
    /* DOS doesn't care about version numbers */
#include "lispver1.h"
#else
#include "lispver2.h"
#endif /* DOS */
