/* @(#) inlnPS2.h Version 1.1 (4/21/92). copyright Venue & Fuji Xerox  */
...
#define fn_section1(lbl,lpfx,nargs) \
  ...
  int RESTARGS;						\
    asm volatile("							\n\
	movl eax,esi	// fn_atom_index = 			\n\
	xorb al,$3		// get_AtomNo_PCMAC1			\n\
	movzbl edx,(eax)						\n\
	sall edx,$16							\n\
	leal eax,1(esi)						\n\
	xorb al,$3							\n\
...
#define fnx_section1(lbl,lpfx,nargs) \
  ...
  int RESTARGS;						\
	...
	xorb al,$3							\n\
	movzbl edx,(eax)						\n\
	movl	%1,edx	// num_args = Get_Byte_PCMAC1;		\n\
	leal eax,1(esi)	// fn_atom_index = 			\n\
	xorb al,$3		// get_AtomNo_PCMAC1			\n\
	movzbl edx,(eax)						\n\
	sall edx,$16							\n\
	leal eax,2(esi)						\n\
